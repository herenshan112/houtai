...
<div class="rol order-nav-box">
    <div class="m-box">
        ...
        <a href="<?php echo U('serv');?>" class="lt order-nav-btn<?php echo $status==5 ? ' on':'';?>">
            <div class="rol order-icon-rol center">
                <img src="/Public/wx/img/o5-<?php echo $status==5 ? 'on':'off';?>.png" alt="">
            </div>
...
<?php if(is_array($order_rows)): foreach($order_rows as $key=>$order_row): ?><div class="rol order-1-box">
    ...
    <div class="rol order-1-rol2">
        <div class="m-box">
            ...
            <?php if($status == 1): ?><a href="<?php echo U('cancel', array('id'=>$order_row['id']));?>" class="gt or-btn1">取消订单</a>
