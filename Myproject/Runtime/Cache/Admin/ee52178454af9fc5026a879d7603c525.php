...
<body>
    ...
    <div class="formbody">
		...
		<form action="/Admin/User/addhuiyuan/action/<?php echo ($action); ?>/typeid/<?php echo ($typeid); ?>/id/<?php echo ($id); ?>" method="post" name="myform" id="myform">
		...
		<table border="0" cellpadding="0" cellspacing="0" style="float: left;; margin: 0 0 0 25px;">
			...
			<tr>
				...
				<input type="text" class="dfinput" id="toppic" name='headpic' value="<?php echo ($list["headpic"]); ?>" /> <input type="button" id="uploadbtndf" value="选择图片" onclick="getElementById('uppicimg').click()" style="height:30px;width:80px;cursor:pointer;border-radius:2px;background-color:#DDD;" />
			...
			<tr>
				...
				<td><img id="mytxpic" src="<?php echo ($list["headpic"]); ?>" style="width:150px;"></td>
				<td><em id="sky_9" style="display: none;"></em></td>
			</tr>
			<tr>
