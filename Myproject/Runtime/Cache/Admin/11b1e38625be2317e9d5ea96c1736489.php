...
<body>
    ...
    <div class="formbody">
		...
		<form action="/Admin/Orders/lookjs?action=js" method="post" name="myform">
		...
		<li><span class="title_dingdan">订单状态</span></li>
		<li><label>订单状态:</label><cite>
			<?php echo ($fhzt); ?>
		</cite></li>
		<li><span class="title_dingdan">订单记录</span></li>
		<li><label>订单记录:</label><cite>
			<?php echo ($ddju["ordlc_cont"]); ?>
		</cite></li>
