...
<body>
	...
	<div class="place">
		...
		<li><a href="#">列表</a></li>
		<ul class="toolbar1">
			<li class="click"><a href="<?php echo U('News/zizhiadd',array('action'=>'add'));?>"><span></span>添加资质</a></li>				
		</ul>
		...
		<table class="imgtable">
			...
			<?php if(is_array($news_list)): foreach($news_list as $key=>$list): ?><tr>
				...
				<td>
					...
					<p><a href="/Admin/News/zizhiadd/action/eite/id/<?php echo ($list["id"]); ?>">修改</a></p>

					<p><a href="/Admin/News/zizhiadd/id/<?php echo ($list["id"]); ?>" onclick="if (confirm('确定要删除吗？')) return true; else return false;">删除</a></p>
