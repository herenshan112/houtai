...
<body>
    ...
    <div class="formbody">
		<div class="formtitle"><span>结算</span></div>

		<form action="/Admin/Statis/lookjs?action=js" method="post" name="myform">
		...
		<li><label>发货方:</label><cite><?php echo (dachukk($order_row["fahuofang"])); ?></cite></li>
		...
		<li><span class="title_dingdan">结算信息</span></li>
		
		<li><label>订单状态:</label><cite>
			<?php echo ($fhzt); ?>
		</cite></li>
		
		
		<li><label>订单价格:</label><cite><?php echo ($order_row["money"]); ?></cite></li>
		<li><label>经销商价格:</label><cite><?php echo (jsxjagejs($order_row["ordernum"])); ?></cite></li>
		
		<?php switch($order_row["sfjsset"]): case "1": ?><li><label>结算进度:</label><cite><font color="#D9D300">等待经销商确认</font></cite></li><li><label>备注:</label><cite><?php echo ($jscont["jiesuanbeizhu"]); ?></cite></li><?php break;?>    
			<?php case "2": ?><li><label>结算进度:</label><cite><font color="#008000">完成</font></cite></li><li><label>平台发起备注:</label><cite><?php echo ($jscont["jiesuanbeizhu"]); ?></cite></li><li><label>经销商确认备注:</label><cite><?php echo ($jscont["qrbeizhu"]); ?></cite></li><?php break;?>    
			<?php default: ?><li><label>结算进度:</label><cite><font color="#ff0000">未结算</font></cite></li><?php endswitch;?>
