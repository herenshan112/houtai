...
<body>
    ...
    <div class="formbody">
		...
		<form action="/Admin/News/gywm?id=<?php echo ($list["id"]); ?>" method="post" enctype="multipart/form-data" name="myform">
		<ul class="forminfo">

		<li><label>标题:</label><input name="title" class="dfinput" type="text" value="<?php echo ($list["title"]); ?>" /><i></i></li>
		
		<li><label>简介:</label><textarea name="smalltext" class="textinput" style="height: 80px"><?php echo ($list["smalltxt"]); ?></textarea><i></i></li>
		<li><label>内容:</label><textarea id="pagecontent" name="content" rows="20" cols="100" style="width:65%;height:300px;visibility:hidden;"><?php echo ($list["cont"]); ?></textarea></li>
