...
<li><a href="#">列表</a></li>
    ...
    <div class="rightinfo">
		...
		<table class="imgtable">
			...
			<tbody>
			<?php if($log_lists != null): if(is_array($log_lists)): foreach($log_lists as $key=>$log_item): ?><tr style="height:32px">
					<td><?php echo ($log_item["id"]); ?></td>
					<td><?php echo ($log_item["usertype"]); ?></td>
					<td><?php echo $username_lists[$log_item['userid']]['username'].'('.$username_lists[$log_item['userid']]['nickname'].')';?></td>
					<td><?php echo $log_item['logip'];?></td>
					<td><?php echo ($log_item["logtime"]); ?></td>
