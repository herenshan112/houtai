    ...
    <div class="rightinfo">
		<div class="tools">
			<ul class="forminfo" style="float:left;">
				<form name="search_form" action="/Admin/Exporsitc/index" method="POST">
				<li><label>统计帐号：</label>
					<select class="select3 scinput" name="status">
				...
				<li><label>开始日期：</label><input type="text" class="scinput" name="starttime" id="starttime" placeholder="请输入开始日期..." /><div id="st" style="width: 350px;"></div></li>
				<li><label>结束日期：</label><input type="text" class="scinput" name="endtime" id="endtime" placeholder="请输入结束日期..." /><div id="et" style="width: 350px;"></div></li>
				<li><label>&nbsp;</label><input type="submit" value="导出" class="scbtn" /></li>
				</form>
			</ul>

			<!--ul class="toolbar1">
				<li class="click"><a href="<?php echo U('add');?>"><span><img src="/Public/Admin/images/t01.png" /></span>添加</a></li>
			</ul-->
