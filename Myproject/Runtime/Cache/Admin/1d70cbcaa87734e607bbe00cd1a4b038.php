...
<li><a href="#">列表</a></li>
    ...
    <div class="rightinfo">
		<div class="tools">
			...
			<ul class="toolbar">
			<li class="click"><a href="<?php echo U('adduser');?>"><span><img src="/Public/Admin/images/t01.png" /></span>添加</a></li>
			</ul>
		...
		<table class="imgtable">
			...
			<tbody>
			<?php if($lists != null): if(is_array($lists)): foreach($lists as $key=>$list_item): ?><tr style="height:32px">
					<td><?php echo ($list_item["id"]); ?></td>
					<td><?php echo ($list_item["username"]); ?></td>
					<td><?php echo ($list_item["nickname"]); ?></td>
					<td><?php echo ($list_item["authority"]); ?></td>
					<td><a href="<?php echo U('moduser', array('id'=>$list_item['id']));?>">修改</a> <a href="<?php echo U('deluser', array('id'=>$list_item['id']));?>" onclick="return confirm('是否要删除此条记录，删除后不可恢复?');">删除</a></td>
					</tr><?php endforeach; endif; ?>
			<?php else: ?>
				<tr style="height:32px"><td colspan="6">暂无记录！</td></tr><?php endif; ?>
			</tbody>
