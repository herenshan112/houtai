...
    <div class="rightinfo">		<div class="tools">			<ul class="toolbar1" style="float:left;">				<li class="click"><a href="<?php echo U('add');?>"><span><img src="/Public/Admin/images/t01.png" /></span>添加</a></li>			</ul>			<!--ul class="toolbar1">			<li><span><img src="images/t05.png" /></span>设置</li>			</ul-->		</div>		<table class="imgtable">			<thead>			<tr>			<th>名称</th>			<th>操作</th>			</tr>			</thead>			<tbody>			<?php if(is_array($shipper_list)): foreach($shipper_list as $key=>$list): ?><tr>				<td><?php echo ($list["name"]); ?></td>				<td>					<p><a href="/Admin/Shipper/mod/id/<?php echo ($list["id"]); ?>">修改</a></p>					<p><a href="/Admin/Shipper/del/id/<?php echo ($list["id"]); ?>" onclick="if (confirm('确定要删除吗？')) return true; else return false;">删除</a></p>				</td>				</tr><?php endforeach; endif; ?>			</tbody>		</table>		<div class="yellow"><?php echo ($page); ?></div>    </div><script type="text/javascript">$('.imgtable tbody tr:odd').addClass('odd');</script>
