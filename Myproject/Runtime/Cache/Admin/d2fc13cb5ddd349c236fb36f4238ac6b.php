...
<body>
	...
	<div class="place">
		...
		<li><a href="#">总部<?php if(($ly) == "1"): ?>发货<?php else: ?>推广<?php endif; ?>统计</a></li>
    ...
    <div class="rightinfo">
		<div class="tools">
			<ul class="seachform" style="float:left;">
				<form name="search_form" action="<?php echo U('lookcont');?>?ly=<?php echo ($ly); ?>" method="post">
				...
				<li><label>&nbsp;</label><input type="button" value="导出" class="scbtn" onclick="exportongji(<?php if(($ly) == "1"): ?>1<?php else: ?>0<?php endif; ?>)" /></li>
				</form>
